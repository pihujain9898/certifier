...
<div class="usr-home-btn-contain">
    <button class="usr-home-btn btn">Let's Certify</button>
    <div class="usr-home-btn-particles">
    </div>
</div>
...
<script>
    ...
    for(i = 0; i < num; i++) {
        ...
        btn.siblings('.usr-home-btn-particles').append(shape);
